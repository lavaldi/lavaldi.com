...
export default ({data}) => {
    const image = (data.image) ? data.image : "http://lavaldi.com/static/lavaldi.jpg"
    return (
      <Head>
        <meta charset="utf-8" />
        ...
        <meta property="og:title" content={"La Valdi | " + data.title} />
        ...
        <title>La Valdi | {data.title}</title>
