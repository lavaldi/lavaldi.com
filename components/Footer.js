...
export default function Footer() {
  return (
    <footer className="flex flex-col justify-center items-start max-w-2xl mx-auto w-full mb-8">
      ...
      <div className="w-full max-w-2xl grid grid-cols-2 gap-1 pb-16 sm:grid-cols-4">
        <Link href="/">
          <a className="text-purple-800 hover:text-purple-900 dark:text-gray-500 dark:hover:text-gray-600 transition">Home</a>
        </Link>
        <Link href="/about">
